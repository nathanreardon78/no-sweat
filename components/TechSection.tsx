      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div>
          ...
          <p
            ...
            style={{ color: COLORS.jetBlack }}
          >
            No Sweat™ utilises a proprietary silica‑based micro‑layer that forms
            an invisible shield on the surface of your drinkware. This
            hydrophobic barrier prevents condensation from ever forming, keeping
            your drinkware completely dry instead of merely beading water
            droplets.
          </p>
